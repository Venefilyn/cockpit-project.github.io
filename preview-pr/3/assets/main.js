...
(function (){
    ...
    function browserCheck() {
        ...
        return (
            ...
            /* Check xhr2: XMLHttpRequest in window */
            req('XMLHttpRequest', window) && 
            /* Check namevalue-storage: sessionStorage in window */
            req('sessionStorage', window) && 
            /* Check json: JSON in window */
            req('JSON', window) && 
            /* Check es5: defineProperty in Object */
            req('defineProperty', Object) && 
            /* Check console-basic: console in window */
            req('console', window) && 
            /* Check history: pushState in window.history */
            req('pushState', window.history) && 
            /* Check textcontent: textContent in document */
            req('textContent', document) && 
            /* Check css-variables: CSS in window */
            req('CSS', window) && 
            /* Check css-supports-api: @supports(selector(test)) */
            css('selector(test)') && 
            /* Check promise-finally: finally in Promise.prototype */
            req('finally', Promise.prototype) && 
            /* Check mdn-javascript_builtins_string_replaceall: replaceAll in String.prototype */
            req('replaceAll', String.prototype) && 
            /* Check flexbox: @supports(display:flex) */
            css('display', 'flex') && 
            /* Check css-grid: @supports(display:grid) */
            css('display', 'grid') && 
            /* Check mdn-css_selectors_where: @supports(selector(:is(*):where(*))) */
